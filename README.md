# ⛓ OpenHash Korea National Node

![Layer](https://img.shields.io/badge/Layer-4-orange)
...
|---|---|
| Node ID | `KR` |
| Layer | L4 — Korea National |
| Endpoint | `https://nounweb.github.io/openhash-L4-kr` |
...
curl -X POST \
  ...
  https://api.github.com/repos/nounweb/openhash-L4-kr/dispatches \
  -d '{
